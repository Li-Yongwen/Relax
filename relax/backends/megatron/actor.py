...
class _SFTPrepackedDeviceIterator:
    ...
    def __next__(self) -> tuple[PrepackedBatch, Any]:
        ...
        train_stream = Mod.current_stream(self._device)
...
class MegatronTrainRayActor(TrainRayActor):
    ...
    def _init(
        ...
        if self._sft_window_prefetcher is not None:
            ...
            self._sft_prefetch_stream = Mod.Stream(device=self._sft_device)
            self._sft_copy_stream = Mod.Stream(device=self._sft_device)
    ...
    def _get_prefetched_sft_window(
        ...
        if local_k < max_k:
            try:
                ...
                with Mod.stream_context(self._sft_copy_stream):
    ...
    def _pack_sft_prepack_window(
        ...
        assert self._sft_device is not None
        Mod.set_device(self._sft_device)
        ...
        with Mod.stream_context(self._sft_prefetch_stream):
